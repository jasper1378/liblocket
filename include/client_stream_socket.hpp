...
namespace locket
{
    class client_stream_socket : public stream_socket
    {
        ...
        public:
            ...
            client_stream_socket(socket::dummy_type_connect, const socket_addr* connected_addr);
            client_stream_socket(const socket_addr* bound_addr, const socket_addr* connected_addr);
