...
liblocket::inet4_socket_addr::inet4_socket_addr() : m_addr{} {
  inet4_socket_addr::clear();
  inet4_socket_addr::set_domain();
}

liblocket::inet4_socket_addr::inet4_socket_addr(in_port_t port) : m_addr{} {
  inet4_socket_addr::clear();
  inet4_socket_addr::set_domain();
  init(in_addr{INADDR_ANY}, port);
}

liblocket::inet4_socket_addr::inet4_socket_addr(in_addr addr, in_port_t port)
    : m_addr{} {
  inet4_socket_addr::clear();
  inet4_socket_addr::set_domain();
  init(addr, port);
...
liblocket::inet4_socket_addr::inet4_socket_addr(const sockaddr_in &other)
    : m_addr{other} {}
...
liblocket::inet4_socket_addr *liblocket::inet4_socket_addr::create_new() const {
...
bool liblocket::inet4_socket_addr::is_set() const {
...
std::string liblocket::inet4_socket_addr::to_string() const {
...
sockaddr *liblocket::inet4_socket_addr::socket_addr_ptr() {
  return reinterpret_cast<sockaddr *>(&m_addr);
}

const sockaddr *liblocket::inet4_socket_addr::socket_addr_ptr() const {
  return reinterpret_cast<const sockaddr *>(&m_addr);
}

sockaddr_in *liblocket::inet4_socket_addr::socket_addr_in4_ptr() {
  return &m_addr;
}

const sockaddr_in *liblocket::inet4_socket_addr::socket_addr_in4_ptr() const {
  return &m_addr;
}
...
liblocket::inet4_socket_addr &
liblocket::inet4_socket_addr::operator=(inet4_socket_addr &&other) noexcept {
  m_addr = other.m_addr;
...
void liblocket::inet4_socket_addr::init(in_addr addr, in_port_t port) {
