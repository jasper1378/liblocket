...
liblocket::unix_socket_addr::unix_socket_addr(const sockaddr *other)
...
liblocket::unix_socket_addr::unix_socket_addr(const sockaddr_un &other)
    : m_addr{other} {
  m_is_abstract = check_if_abstract();
}

liblocket::unix_socket_addr::unix_socket_addr(const unix_socket_addr &other)
    : m_addr{other.m_addr}, m_is_abstract{other.m_is_abstract} {}

liblocket::unix_socket_addr::unix_socket_addr(unix_socket_addr &&other) noexcept
    : m_addr{other.m_addr}, m_is_abstract{other.m_is_abstract} {}

liblocket::unix_socket_addr::~unix_socket_addr() {}

liblocket::unix_socket_addr *liblocket::unix_socket_addr::create_new() const {
  return new unix_socket_addr{};
}

liblocket::unix_socket_addr *liblocket::unix_socket_addr::create_clone() const {
...
bool liblocket::unix_socket_addr::is_set() const {
...
std::string liblocket::unix_socket_addr::to_string() const {
  return std::string{m_addr.sun_path};
}

sockaddr *liblocket::unix_socket_addr::socket_addr_ptr() {
  return reinterpret_cast<sockaddr *>(&m_addr);
}

const sockaddr *liblocket::unix_socket_addr::socket_addr_ptr() const {
...
bool liblocket::unix_socket_addr::is_abstract() const { return m_is_abstract; }

liblocket::unix_socket_addr &
liblocket::unix_socket_addr::operator=(const unix_socket_addr &other) {
  m_addr = other.m_addr;
...
liblocket::unix_socket_addr &
liblocket::unix_socket_addr::operator=(unix_socket_addr &&other) noexcept {
  m_addr = other.m_addr;
  m_is_abstract = other.m_is_abstract;
...
void liblocket::unix_socket_addr::clear() { std::memset(&m_addr, 0, m_k_size); }

void liblocket::unix_socket_addr::set_domain() { m_addr.sun_family = AF_UNIX; }

bool liblocket::unix_socket_addr::check_if_abstract() const {
